%-----------------------------------------------------------------
% category graphs
\def\vertices{\ensuremath{\mathsf{vertices}} \index{vertices@\textsf{vertices}}}
\def\edges{\ensuremath{\mathsf{edges}}\index{edges@\textsf{edges}} }
\def\compose{\ensuremath{\mathsf{compose}}\index{compose@\textsf{compose}} }
\def\comop{\ensuremath{\circ}\index{compose operation $\circ$} }
\def\identity{\ensuremath{\mathsf{identity}}\index{identity@\textsf{identity}} }
\def\head{\ensuremath{\mathsf{head}}\index{head@\textsf{head}} }
\def\tail{\ensuremath{\mathsf{tail}}\index{tail@\textsf{tail}} }
\def\pvalue{\ensuremath{\mathsf{value}\index{value@(path) \textsf{value}}} }
\def\concatenate{\ensuremath{\mathsf{concatenate}}\index{concatenate@\textsf{concatenate}} }
\def\conop{\ensuremath{\odot}\index{concat operation $\odot$} } 
\def\peq{\ensuremath{\simeq}\index{path equivalence $\simeq$} }
%-----------------------------------------------------------------
% logic
\def\implies{\ensuremath{\Rightarrow} }
\def\liff{\ensuremath{\Leftrightarrow} }
\def\land{\ensuremath{\wedge} }
\def\lor{\ensuremath{\vee} }
\def\lnot{\ensuremath{\vee} }
%-----------------------------------------------------------------
% linear spaces
\def\scalars{\ensuremath{\mathsf{scalars}} }
\def\vectors{\ensuremath{\mathsf{vectors}} }
%-----------------------------------------------------------------
...
\def\Ffacet{\phi}
\def\Eedge{\epsilon}
\def\SimplicialComplex{K}{\mathcal{K}}  % An abstract simplicial complex
