...
\begin{equation}
\begin{aligned}
v_1 & =  \left(a_2+a_3 u_1\right) u_1^{2}+a_1 u_1 \\[2ex] v_2 & =  \left(a_2+a_3 u_2\right) u_2^{2}+
a_1 u_2 \\[2ex] 1 & = a_2+a_3+a_1 \\[2ex] 0 & = \left(2 a_2+3 a_3 \hat{u}\right) \hat{u}+a_1
\end{aligned}
\end{equation}
\newpage
...
\begin{equation}
\begin{aligned}
a_1 & = \left(\left(u_2^{2}-v_2\right) u_1^{3}+\left(u_2-1\right) u_2^{2} v_1-
\left(u_2^{3}-v_2\right) u_1^{2}\right)/\left(\left(u_1-u_2\right) \left(u_1-1
\right) \left(u_2-1\right) u_1 u_2\right) \\[2ex] a_2 & = \left(-\left(\left(u_2-v_2
\right) u_1^{3}+\left(u_2+1\right) \left(u_2-1\right) u_2 v_1\right)+\left(u_2
^{3}-v_2\right) u_1\right)/\left(\left(u_1-u_2\right) \left(u_1-1\right) 
\left(u_2-1\right) u_1 u_2\right) \\[2ex] a_3 & = \left(\left(u_2-v_2\right) u_1^{2}+
\left(u_2-1\right) u_2 v_1-\left(u_2^{2}-v_2\right) u_1\right)/\left(\left(u_1-
u_2\right) \left(u_1-1\right) \left(u_2-1\right) u_1 u_2\right) \\[2ex] \hat{u} & = \left(
-\left(\left(u_2^{3}-v_2\right) u_1-\sqrt {-\left(\left(\left(2 v_2-3\right)
 v_1-3 v_2\right) u_2^{3}+3 u_2^{5}+u_2^{4} v_1+u_2 v_1 v_2+3 v_2^{2}-\left(\left(
3 v_2-2\right) v_1+3 v_2\right) u_2^{2}\right) u_1^{3}+\left(\left(3 \left(v_2
+1\right) v_1-2 v_2\right) u_2^{3}+u_2^{6}+3 u_2^{5} v_1-6 u_2^{4} v_1-6 u_2^{2} 
v_1 v_2+3 u_2 v_1 v_2+v_2^{2}\right) u_1^{2}-\left(\left(2 u_2^{4}-u_2^{3}+u_2 v_2-
2 v_2\right) u_1-\left(u_2^{2}-u_2+1\right) \left(u_2-1\right) u_2 v_1\right) 
\left(u_2-1\right) u_2 v_1-\left(3 \left(u_2^{2}-v_2\right)-\left(u_2-v_2
\right) u_1\right) \left(u_2-v_2\right) u_1^{5}+\left(4 u_2^{4}-u_2^{3} v_2-6 
u_2^{2} v_2-u_2 v_2+4 v_2^{2}\right) u_1^{4}}\right)+\left(u_2-v_2\right) u_1^{3}
+\left(u_2+1\right) \left(u_2-1\right) u_2 v_1\right)/\left(3 \left(\left(u_2
-v_2\right) u_1^{2}+\left(u_2-1\right) u_2 v_1\right)-3 \left(u_2^{2}-v_2
\right) u_1\right)
\end{aligned}
\end{equation}
\newpage
...
\begin{equation}
\begin{aligned}
\left(\left(2 \sqrt {-\left(\left(\left(2 v_2-3\right) v_1-3 v_2\right) u_2
^{3}+3 u_2^{5}+u_2^{4} v_1+u_2 v_1 v_2+3 v_2^{2}-\left(\left(3 v_2-2\right) v_1+3
 v_2\right) u_2^{2}\right) u_1^{3}-\left(\left(3 \left(u_2^{2}-v_2\right)-
\left(u_2-v_2\right) u_1\right) \left(u_2-v_2\right) u_1-\left(4 u_2^{4}-u_2^{3}
 v_2-6 u_2^{2} v_2-u_2 v_2+4 v_2^{2}\right)\right) u_1^{4}+\left(\left(3 \left(
v_2+1\right) v_1-2 v_2\right) u_2^{3}+u_2^{6}+3 u_2^{5} v_1-6 u_2^{4} v_1-6 u_2^{2
} v_1 v_2+3 u_2 v_1 v_2+v_2^{2}\right) u_1^{2}-\left(\left(2 u_2^{4}-u_2^{3}+u_2 
v_2-2 v_2\right) u_1-\left(u_2^{2}-u_2+1\right) \left(u_2-1\right) u_2 v_1
\right) \left(u_2-1\right) u_2 v_1} u_2-2 \sqrt {-\left(\left(\left(2 v_2-3
\right) v_1-3 v_2\right) u_2^{3}+3 u_2^{5}+u_2^{4} v_1+u_2 v_1 v_2+3 v_2^{2}-
\left(\left(3 v_2-2\right) v_1+3 v_2\right) u_2^{2}\right) u_1^{3}-\left(
\left(3 \left(u_2^{2}-v_2\right)-\left(u_2-v_2\right) u_1\right) \left(u_2-v_2
\right) u_1-\left(4 u_2^{4}-u_2^{3} v_2-6 u_2^{2} v_2-u_2 v_2+4 v_2^{2}\right)
\right) u_1^{4}+\left(\left(3 \left(v_2+1\right) v_1-2 v_2\right) u_2^{3}+u_2
^{6}+3 u_2^{5} v_1-6 u_2^{4} v_1-6 u_2^{2} v_1 v_2+3 u_2 v_1 v_2+v_2^{2}\right) u_1
^{2}-\left(\left(2 u_2^{4}-u_2^{3}+u_2 v_2-2 v_2\right) u_1-\left(u_2^{2}-u_2+1
\right) \left(u_2-1\right) u_2 v_1\right) \left(u_2-1\right) u_2 v_1} v_2+2 u_1
^{3} u_2^{2}-4 u_1^{3} u_2 v_2+2 u_1^{3} v_2^{2}-3 u_1^{2} u_2^{3}+3 u_1^{2} u_2^{
2} v_2+3 u_1^{2} u_2 v_2-3 u_1^{2} v_2^{2}+u_1 u_2^{4}+2 u_1 u_2^{3} v_2-6 u_1 u_2^{2
} v_2+2 u_1 u_2 v_2+u_1 v_2^{2}-u_2^{4} v_1-2 u_2^{3} v_1 v_2+3 u_2^{3} v_1+3 u_2^{2} 
v_1 v_2-2 u_2^{2} v_1-u_2 v_1 v_2\right) \left(u_1^{4} u_2-u_1^{4} v_2-2 u_1^{3} u_2
^{2}+2 u_1^{3} v_2+u_1^{2} u_2^{3}+3 u_1^{2} u_2^{2} v_1-3 u_1^{2} u_2 v_1-u_1^{2} 
v_2-2 u_1 u_2^{3} v_1+2 u_1 u_2 v_1+u_2^{3} v_1-u_2^{2} v_1\right)\right)/\left(6 
\sqrt {-\left(\left(\left(2 v_2-3\right) v_1-3 v_2\right) u_2^{3}+3 u_2^{5}+
u_2^{4} v_1+u_2 v_1 v_2+3 v_2^{2}-\left(\left(3 v_2-2\right) v_1+3 v_2\right) u_2
^{2}\right) u_1^{3}-\left(\left(3 \left(u_2^{2}-v_2\right)-\left(u_2-v_2
\right) u_1\right) \left(u_2-v_2\right) u_1-\left(4 u_2^{4}-u_2^{3} v_2-6 u_2^{2
} v_2-u_2 v_2+4 v_2^{2}\right)\right) u_1^{4}+\left(\left(3 \left(v_2+1\right)
 v_1-2 v_2\right) u_2^{3}+u_2^{6}+3 u_2^{5} v_1-6 u_2^{4} v_1-6 u_2^{2} v_1 v_2+3 
u_2 v_1 v_2+v_2^{2}\right) u_1^{2}-\left(\left(2 u_2^{4}-u_2^{3}+u_2 v_2-2 v_2
\right) u_1-\left(u_2^{2}-u_2+1\right) \left(u_2-1\right) u_2 v_1\right) 
\left(u_2-1\right) u_2 v_1} \left(\left(u_2-v_2\right) u_1^{2}+\left(u_2-1
\right) u_2 v_1-\left(u_2^{2}-v_2\right) u_1\right)^{2}\right) \\[2ex] \left(-
\left(2 \sqrt {-\left(\left(\left(2 v_2-3\right) v_1-3 v_2\right) u_2^{3}+3 
u_2^{5}+u_2^{4} v_1+u_2 v_1 v_2+3 v_2^{2}-\left(\left(3 v_2-2\right) v_1+3 v_2
\right) u_2^{2}\right) u_1^{3}-\left(\left(3 \left(u_2^{2}-v_2\right)-\left(
u_2-v_2\right) u_1\right) \left(u_2-v_2\right) u_1-\left(4 u_2^{4}-u_2^{3} v_2-6 
u_2^{2} v_2-u_2 v_2+4 v_2^{2}\right)\right) u_1^{4}+\left(\left(3 \left(v_2+1
\right) v_1-2 v_2\right) u_2^{3}+u_2^{6}+3 u_2^{5} v_1-6 u_2^{4} v_1-6 u_2^{2} v_1
 v_2+3 u_2 v_1 v_2+v_2^{2}\right) u_1^{2}-\left(\left(2 u_2^{4}-u_2^{3}+u_2 v_2-2 
v_2\right) u_1-\left(u_2^{2}-u_2+1\right) \left(u_2-1\right) u_2 v_1\right) 
\left(u_2-1\right) u_2 v_1} u_2-2 \sqrt {-\left(\left(\left(2 v_2-3\right) v_1
-3 v_2\right) u_2^{3}+3 u_2^{5}+u_2^{4} v_1+u_2 v_1 v_2+3 v_2^{2}-\left(\left(3 
v_2-2\right) v_1+3 v_2\right) u_2^{2}\right) u_1^{3}-\left(\left(3 \left(u_2^{
2}-v_2\right)-\left(u_2-v_2\right) u_1\right) \left(u_2-v_2\right) u_1-\left(4 
u_2^{4}-u_2^{3} v_2-6 u_2^{2} v_2-u_2 v_2+4 v_2^{2}\right)\right) u_1^{4}+\left(
\left(3 \left(v_2+1\right) v_1-2 v_2\right) u_2^{3}+u_2^{6}+3 u_2^{5} v_1-6 u_2
^{4} v_1-6 u_2^{2} v_1 v_2+3 u_2 v_1 v_2+v_2^{2}\right) u_1^{2}-\left(\left(2 u_2
^{4}-u_2^{3}+u_2 v_2-2 v_2\right) u_1-\left(u_2^{2}-u_2+1\right) \left(u_2-1
\right) u_2 v_1\right) \left(u_2-1\right) u_2 v_1} v_2+2 u_1^{3} u_2^{2}-4 u_1^{3
} u_2 v_2+2 u_1^{3} v_2^{2}-3 u_1^{2} u_2^{3}+3 u_1^{2} u_2^{2} v_2+3 u_1^{2} u_2 
v_2-3 u_1^{2} v_2^{2}+u_1 u_2^{4}+2 u_1 u_2^{3} v_2-6 u_1 u_2^{2} v_2+2 u_1 u_2 v_2+u_1
 v_2^{2}-u_2^{4} v_1-2 u_2^{3} v_1 v_2+3 u_2^{3} v_1+3 u_2^{2} v_1 v_2-2 u_2^{2} v_1-
u_2 v_1 v_2\right) \left(u_1-u_2\right) \left(u_1-1\right) \left(u_2-1\right) 
u_1 u_2\right)/\left(6 \sqrt {-\left(\left(\left(2 v_2-3\right) v_1-3 v_2
\right) u_2^{3}+3 u_2^{5}+u_2^{4} v_1+u_2 v_1 v_2+3 v_2^{2}-\left(\left(3 v_2-2
\right) v_1+3 v_2\right) u_2^{2}\right) u_1^{3}-\left(\left(3 \left(u_2^{2}-
v_2\right)-\left(u_2-v_2\right) u_1\right) \left(u_2-v_2\right) u_1-\left(4 u_2
^{4}-u_2^{3} v_2-6 u_2^{2} v_2-u_2 v_2+4 v_2^{2}\right)\right) u_1^{4}+\left(
\left(3 \left(v_2+1\right) v_1-2 v_2\right) u_2^{3}+u_2^{6}+3 u_2^{5} v_1-6 u_2
^{4} v_1-6 u_2^{2} v_1 v_2+3 u_2 v_1 v_2+v_2^{2}\right) u_1^{2}-\left(\left(2 u_2
^{4}-u_2^{3}+u_2 v_2-2 v_2\right) u_1-\left(u_2^{2}-u_2+1\right) \left(u_2-1
\right) u_2 v_1\right) \left(u_2-1\right) u_2 v_1} \left(\left(u_2-v_2\right) 
u_1^{2}+\left(u_2-1\right) u_2 v_1-\left(u_2^{2}-v_2\right) u_1\right)^{2}
\right)
\end{aligned}
\end{equation}
\newpage
...
%-----------------------------------------------------------------
\levelstay{Input}
\label{sec:lagrange-ydyd}

Hermite interpolation as in section~\ref{sec:Monomial-cubic-hermite}
We need 
\begin{align}
\lambda^{\text{hermite}}_0(x_0) & = 1 \\ 
\lambda^{\text{hermite}}_0(x_1) & = 0 \nonumber \\
\partial\lambda^{\text{hermite}}_0(x_2) & = 0 \nonumber \\
\partial\lambda^{\text{hermite}}_0(x_3) & = 0 \nonumber 
\end{align}
...
For $\lambda^{\text{hermite}}_2$ and $\lambda^{\text{hermite}}_3$, 
consider functions of the form $(x-x_0)(x-x_1)(x-c_i)$.
We need, for example, 
\begin{align}
\lambda^{\text{hermite}}_3(x_0) & = 1 \\ 
\lambda^{\text{hermite}}_3(x_1) & = 0 \nonumber \\
\partial\lambda^{\text{hermite}}_3(x_2) & = 0 \nonumber \\
\partial\lambda^{\text{hermite}}_3(x_3) & = 1 \nonumber 
\end{align}
...
section~\ref{sec:lagrange-hermite}:
\begin{align}
...
% \end{align}
% This is essentially the same problem as that of $\lambda^{\text{hermite}}_0$
% in section~\ref{sec:lagrange-hermite},
% so the solution is:
% \begin{align}
