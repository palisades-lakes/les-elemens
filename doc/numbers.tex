...
\leveldown{Cyclic natural numbers}
...
\leveldown{\texttt{byte}, \texttt{short}, \texttt{int}, \texttt{long}}
\label{sec:int}
...
\leveldown{IEEE 754 floating point}
