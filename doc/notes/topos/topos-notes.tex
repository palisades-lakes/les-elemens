...
objects. (E.g., a diagram is what is pictured.) \\
...
A \textit{diagram} in $G$ of shape $I$
is a graph homomorphism $D : I \rightarrow G$ of graphs. 
\end{definition}

\begin{definition}[Diagram (map graph to category) 
\textmd{\textcite{asperti_longo_1991}}]
Let $I$ be a directed graphs and $C$ be a category. 
A \textit{diagram} in $G$ of shape $I$
...
A \textit{diagram} is a functor $D : I \rightarrow A$.
$I$ is the \textit{shape} (aka \textit{scheme},
\textit{index category}) of the diagram $D$.\\
...
\textcite[p$18/181$]{perrone_2019_cath_notes} gives
``an informal (but consistent) definition'' 
early,
followed by the incorrect functor takes (small) category to
category definition, still relatively 
early~\cite[p$53/181$]{perrone_2019_cath_notes}.
The informal definition explicitly acknowledges some of
what is \textit{not} drawn; the later formal definition does not.
...
Undefined in: 
\textcite[MacLane]{maclane_1998_cat_for_working_mathematician},
