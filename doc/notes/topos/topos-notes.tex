...
\begin{tikzcd}
V_0 
\arrow[r, bend left=50, "f_0"]
\arrow[r, "f_1"]
\arrow[r, bend right=50, "f_2"]
& V_1 
\arrow[r, "e"]
& V_2 
\end{tikzcd}
...
\end{tikzcd}
\caption{Isic edge $e$, if both paths $V_0 \rightarrow V_0$
are equivalent (compose to the identity loop) and the 
same for both paths $V_1 \rightarrow V_1$.}
\label{fig:isic}
\end{figure}
