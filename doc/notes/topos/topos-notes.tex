...
\begin{figure}
\centering
\begin{tikzcd}[cramped,row sep=1.2cm, column sep=2.5cm]
V_0
...
% \begin{figure}
% \centering
% \begin{tikzcd}[cramped,row sep=1.2cm, column sep=2.4cm]
% V_0
...
\end{tikzcd}
\caption{Completion of fig.~\ref{fig:a-digraph}
to a category}
...
Figure~\ref{fig:a-completed-digraph} shows the additional
edges needed to make the graph in figure~\ref{fig:a-digraph}
...
\arrow[r, "e"]
& V_2 
\arrow[r,Rightarrow,"\mathrm{ if commutes}"]
& V_0 
\arrow[r, "f", "g"']
& V_1 
\end{tikzcd}
