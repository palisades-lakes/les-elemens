...
\begin{itemize}
  ...
  \item monoid action
  \item power object
  \item \ldots more on topoi and l,ogic 
\end{itemize}

Ad\'{a}mek et al:~\cite{adamek_herrlich_strecker_1990}
\begin{itemize}
  \item category and functor
  \item duality
  \item monepisic
  \item categories of categories, small category, quasicategory
  \item subcategory
  \item concrete category and functor
  \item natural transformation
  \item injective objects
