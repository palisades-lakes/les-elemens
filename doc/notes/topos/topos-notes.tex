...
If we define a path as a sequence alternating vertices and edges,
then we can have paths consisting of single vertices,
and the need for $\mathsf{identity}$ is eliminated.
...
alternating, connected vertices and edges, beginning and ending 
with vertices. 
