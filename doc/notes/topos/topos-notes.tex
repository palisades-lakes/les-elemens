...
\begin{definition}{\textbf{Paths}}\mbox{}\\
...
\begin{definition}{\textbf{Kategory}
 (explicit path-equivalence)}\mbox{}\\
...
Two paths are \textit{equivalent} if they have the same 
$\mathsf{value}$.
\end{definition}
