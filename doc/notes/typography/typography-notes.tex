...
person. 
What I have read is not articulated in a way that would inform the
details of an implementation, so I'm putting aside efforts
...
its boundary, rather than as a skeleton path plus expansion.
...
reviously text was written continuously,
without word breaks?
