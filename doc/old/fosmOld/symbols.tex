...
\def\Space{U}{\mathcal{U}}  % vector space
\def\vspace{\mathcal{V}}  % vector space
\def\Space{W}{\mathcal{W}}  % vector space

\def\Space{A}{\mathcal{A}}  % affine space
\def\Space{T}{\mathcal{T}}  % translation space (of an affine space)

\def\Space{L}{\mathcal{L}} % space of of linear maps
