...
% arara: xelatex: { synctex: on, options: [-halt-on-error] }
% arara: xelatex: { synctex: on, options: [-halt-on-error]  }
% arara: clean: { files: [ kindle-test.aux ] }
% arara: clean: { files: [ kindle-test.bbl ] }
% arara: clean: { files: [ kindle-test.bcf ] }
% arara: clean: { files: [ kindle-test.blg ] }
% arara: clean: { files: [ kindle-test.idx ] }
% arara: clean: { files: [ kindle-test.ilg ] }
% arara: clean: { files: [ kindle-test.ind ] }
% arara: clean: { files: [ kindle-test.glo ] }
% % arara: clean: { files: [ kindle-test.log ] }
% arara: clean: { files: [ kindle-test.run.xml ] }
% arara: clean: { files: [ kindle-test.synctex.gz] }
% arara: clean: { files: [ kindle-test.plCode] }
% arara: clean: { files: [ kindle-test.plData] }
% arara: clean: { files: [ kindle-test.plMath] }
% arara: clean: { files: [ kindle-test.plExercise] }
% arara: clean: { files: [ kindle-test.plNote] }
% arara: clean: { files: [ kindle-test.plQuote] }
% arara: clean: { files: [ kindle-test.xdy ] }
% arara: clean: { files: [ kindle-test.mw ] }
%----------------------------------------------------------------
