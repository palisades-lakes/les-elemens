...
% arara: xelatex: { synctex: on, options: [-halt-on-error] }
% arara: xelatex: { synctex: on, options: [-halt-on-error]  }
% arara: clean: { files: [ portrait-test.aux ] }
% arara: clean: { files: [ portrait-test.bbl ] }
% arara: clean: { files: [ portrait-test.bcf ] }
% arara: clean: { files: [ portrait-test.blg ] }
% arara: clean: { files: [ portrait-test.idx ] }
% arara: clean: { files: [ portrait-test.ilg ] }
% arara: clean: { files: [ portrait-test.ind ] }
% arara: clean: { files: [ portrait-test.glo ] }
% % arara: clean: { files: [ portrait-test.log ] }
% arara: clean: { files: [ portrait-test.run.xml ] }
% arara: clean: { files: [ portrait-test.synctex.gz ] }
% arara: clean: { files: [ portrait-test.plCode] }
% arara: clean: { files: [ portrait-test.plData] }
% arara: clean: { files: [ portrait-test.plMath] }
% arara: clean: { files: [ portrait-test.plExercise ] }
% arara: clean: { files: [ portrait-test.plNote ] }
% arara: clean: { files: [ portrait-test.plQuote ] }
% arara: clean: { files: [ portrait-test.xdy ] }
% arara: clean: { files: [ portrait-test.mw ] }
%----------------------------------------------------------------
...
\begin{plQuote}
{\citeauthortitleyear{Thurston:1994:Proof}}%
{thurston0}%
...
\begin{plQuote}
{\citeauthortitleyear{Maclane:1954:Courses}}
{maclane:vspace}
...
multivariate calculus: \citeauthortitleyear{Halmos:1958:Finite}
and \citeauthortitleyear{Spivak:1965:CalculusOnManifolds}.
...
from\\ \citeauthortitleyear{Dugac:1976:DedekindFondements},\\
as quoted in\\ \citeauthortitleyear{Ferreiros:2007:Labyrinth}.}
{dedekindklein}
{\fraklines
