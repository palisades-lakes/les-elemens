...
A function
 $\f(\v_0 \ldots \v_k):\Vspace_0 \oplus \ldots \oplus \Vspace_k \mapsto \Wspace$
...
%-----------------------------------------------------------------
\leveldown{Canonical vector 'volume'}
\label{sec:Canonical-vector-volume}
