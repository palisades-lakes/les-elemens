...
Quanta and WIRED 
magazines \citeAuthorYearTitle{Hartnett:2019:Lurie,Quanta:2019:Lurie}:}
{}
...
Is category theory a good language? \citeAuthorYearTitle{wiki:AbstractNonsense}
...
categories? \citeAuthorYearTitle{wiki:ConcreteCategory}
...
% some are atoms (aka ``ur-elements'' \citeAuthorYearTitle{wiki:Urelement}). \\
% Many versions of set theory do without 
% atoms \citeAuthorYearTitle{wiki:ConstructibleUniverse,wiki:VonNeumannUniverse},
