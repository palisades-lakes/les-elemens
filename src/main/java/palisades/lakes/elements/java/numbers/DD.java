// Borrowed from JTS 1.16.0
// for speed testing vs BigFraction
// accuracy of naive sum and dot product vs exact algorithms
// TODO: revert to immutable DoubleDouble
/*
...
implements Serializable, Comparable, Cloneable
{
   ...
   */
  private double _hi = 0.0;

  /**
   * The low-order component of the double-double precision value.
   */
  private double _lo = 0.0;
   ...
   */
  public DD setValue(final DD value) {
    init(value);
    return this;
  }
   ...
   * @return a self-reference to the DD instance.
   */
  public DD setValue(final double value) {
    init(value);
    return this;
  }
  ...
  private final DD selfMultiply(final double yhi, final double ylo)
  {
    ...
    C = SPLIT * _hi; hx = C-_hi; c = SPLIT * yhi;
    hx = C-hx; tx = _hi-hx; hy = c-yhi;
    C = _hi*yhi; hy = c-hy; ty = yhi-hy;
  ...
  public final DD divide(final DD y)
  {
    ...
    C = _hi/y._hi; c = SPLIT*C; hc =c-C;  u = SPLIT*y._hi; hc = c-hc;
    tc = C-hc; hy = u-y._hi; U = C * y._hi; hy = u-hy; ty = y._hi-hy;
  ...
  {
    double hc, tc, hy, ty, C, c, U, u;
    C = _hi/yhi; c = SPLIT*C; hc =c-C;  u = SPLIT*yhi; hc = c-hc;
  ...
  public final DD reciprocal()
  {
    ...
    hc =c-C;
    u = SPLIT*_hi;
    hc = c-hc; tc = C-hc; hy = u-_hi; U = C*_hi; hy = u-hy; ty = _hi-hy;
    u = ((((hc*hy)-U)+(hc*ty))+(tc*hy))+(tc*ty);
    c = ((((1.0-U)-u))-(C*_lo))/_hi;
  ...
  public DD floor()
  {
    ...
    final double fhi=Math.floor(_hi);
    double flo = 0.0;
  ...
  public DD ceil()
  {
    ...
    final double fhi=Math.ceil(_hi);
    double flo = 0.0;
  ...
  public DD sqrt()
  {
    ...
    final double x = 1.0 / Math.sqrt(_hi);
    final double ax = _hi * x;

    final DD axdd = valueOf(ax);
    final DD diffSq = this.subtract(axdd.sqr());
    final double d2 = diffSq._hi * (x * 0.5);
   ...
   */
  public boolean isNaN() { return Double.isNaN(_hi); }
  ...
  private String extractSignificantDigits(final boolean insertDecimalPoint, final int[] magnitude)
  {
    ...
    for (int i = 0; i <= numDigits; i++) {
       ...
       */
      final int remMag = magnitude(y._hi);
