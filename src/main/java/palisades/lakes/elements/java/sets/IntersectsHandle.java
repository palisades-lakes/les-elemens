...
public final class IntersectsHandle extends Object {
  ...
  synchronized private final MethodHandle 
  ...
  public static final IntersectsHandle make () {
    return new IntersectsHandle(); }
