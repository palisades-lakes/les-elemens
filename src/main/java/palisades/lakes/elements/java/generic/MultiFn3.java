...
import palisades.lakes.elements.java.generic.MultiFn3;
...
public final class MultiFn3 extends AFn {
  ...
  public MultiFn3 (final String name0, 
  ...
  public final MultiFn3 addMethod (final Object dispatchVal,
                                   final IFn method) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn3 removeMethod (final Object dispatchVal) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn3 preferMethod (final Object dispatchValX,
  ...
  private final boolean isA (final Object x, final Object y) {
    if (x instanceof Signature2) {
      if (y instanceof Signature2) {
        final boolean result = ((Signature2) y).isAssignableFrom((Signature2) x);
        return result; }
      return false; }
