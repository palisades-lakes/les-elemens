...
import palisades.lakes.elements.java.generic.MultiFn4;
...
public final class MultiFn4 extends AFn {
  ...
  public MultiFn4 (final String name0, final IFn dispatchFn0,
  ...
  public final MultiFn4 addMethod (final Object dispatchVal,
                                  final IFn method) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn4 removeMethod (final Object dispatchVal) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn4 preferMethod (final Object dispatchValX,
    ...
    if (x instanceof Signature2) {
      if (y instanceof Signature2) {
        final boolean result =
          ((Signature2) y).isAssignableFrom((Signature2) x);
        return result;
      }
      return false;
    }
