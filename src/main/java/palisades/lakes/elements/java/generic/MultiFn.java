...
import palisades.lakes.elements.java.generic.MultiFn;
...
public final class MultiFn extends AFn {
  ...
  public MultiFn (final String name0, final IFn dispatchFn0,
  ...
  public final MultiFn addMethod (final Object dispatchVal,
                                  final IFn method) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn removeMethod (final Object dispatchVal) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn preferMethod (final Object dispatchValX,
