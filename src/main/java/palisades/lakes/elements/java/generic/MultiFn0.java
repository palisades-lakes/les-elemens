...
import palisades.lakes.elements.java.generic.MultiFn0;
...
public final class MultiFn0 extends AFn {
  ...
  public MultiFn0 (final String name0, final IFn dispatchFn0,
    final Object defaultDispatchVal0, final IRef hierarchy0) {
  ...
  public final MultiFn0 reset () {
    rw.writeLock().lock();
    try {
      methodTable =
        methodCache = preferTable = PersistentHashMap.EMPTY;
      cachedHierarchy = null;
      return this;
    }
    finally {
  ...
  public final MultiFn0 addMethod (final Object dispatchVal,
                                  final IFn method) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn0 removeMethod (final Object dispatchVal) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn0 preferMethod (final Object dispatchValX,
  ...
  private final boolean isA (final Object x, final Object y) {
    return RT.booleanCast(isa.invoke(hierarchy.deref(),x,y));
  }

  private final boolean dominates (final Object x, final Object y) {
    return prefers(x,y) || isA(x,y);
  }

  private final IPersistentMap resetCache () {
    rw.writeLock().lock();
    try {
  ...
  private final IFn getFn (final Object dispatchVal) {
