...
import palisades.lakes.elements.java.generic.DynamicFn2a;
...
public final class DynamicFn2a extends AFn {
  ...
  public DynamicFn2a (final String name0) {
  ...
  public final DynamicFn2a reset () {
    rw.writeLock().lock();
    try {
  ...
  public final DynamicFn2a addMethod (final Signature2 k,
                                     final IFn method) {
    rw.writeLock().lock();
    try {
      methodTable = assoc(
  ...
  public final DynamicFn2a addMethod (final Class c0,
                                     final Class c1,
                                     final IFn method) {
  ...
  public final DynamicFn2a removeMethod (final Signature2 k) {
    rw.writeLock().lock();
    try {
  ...
  public final DynamicFn2a removeMethod (final Class c0,
                                        final Class c1) {
  ...
  public final DynamicFn2a preferMethod (final Signature2 k0,
                                        final Signature2 k1) {
    rw.writeLock().lock();
    try {
      if (prefers(k0,k1)) { 
  ...
  public final DynamicFn2a preferMethod (final Class c00,
                                        final Class c01,
                                        final Class c10,
                                        final Class c11) {
    return 
