...
import palisades.lakes.elements.java.generic.MultiFn2;
 ...
 * @since 2017-06-02
 * @version 2017-06-06 clj src\scr  
 */

@SuppressWarnings("unchecked")
public final class MultiFn2 extends AFn {
  ...
  public MultiFn2 (final String name0, 
  ...
  public final MultiFn2 addMethod (final Object dispatchVal,
                                  final IFn method) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn2 removeMethod (final Object dispatchVal) {
    rw.writeLock().lock();
    try {
  ...
  public final MultiFn2 preferMethod (final Object dispatchValX,
  ...
  private final IFn 
  findAndCacheBestMethod (final Object dispatchVal) {
