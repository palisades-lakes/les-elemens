...
;;----------------------------------------------------------------
(ns palisades.lakes.elements.numbers.sum
  ...
  (:import [java.math BigDecimal]
           ...
           [palisades.lakes.elements.java.numbers.sum IFastSum Kahan Naive Pairwise 
            Summers ZhuHayesOnlineExactSum]
           [palisades.lakes.elements.java.accumulate.sum AprationalSum BigDecimalSum
