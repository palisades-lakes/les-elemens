...
;;----------------------------------------------------------------
(ns palisades.lakes.elements.sets.multi1
  ...
  (:require [palisades.lakes.elements.generic.multi :as mgm])
...
;; java.util.Set
;;----------------------------------------------------------------
(mgm/defmethod empty? java.util.Set [^java.util.Set s] 
  (.isEmpty s))
(mgm/defmethod cardinality java.util.Set [^java.util.Set s] 
  (.size s))
(mgm/defmethod contains? 
  [java.util.Set Object] [^java.util.Set s x]
  (.contains s x))
(mgm/defmethod union [Object Object] [s0 s1] 
  (Sets/union s0 s1))
(mgm/defmethod intersection [Object Object] [s0 s1] 
  (Sets/intersection s0 s1))
(mgm/defmethod intersects? [java.util.Set java.util.Set] [s0 s1] 
  (not (Collections/disjoint s0 s1)))
(mgm/defmethod difference [Object Object] [s0 s1] 
...
(mgm/defmethod cardinality Set [^Set set]
  (.cardinality set))
(mgm/defmethod contains? [Set Object] [^Set set x]
  (.contains set x))
(mgm/defmethod union [Object Object] [s0 s1] 
  (Union/make s0 s1))
(mgm/defmethod intersection [Object Object] [s0 s1] 
