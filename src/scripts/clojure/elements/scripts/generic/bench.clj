...
;;----------------------------------------------------------------
(ns elements.scripts.generic.bench
  ...
  (:require [clojure.string :as s]
            ...
            [elements.api :as mc]
            [elements.sets.dynamic2 :as dyna]
            [elements.sets.multi :as multi]
            [elements.sets.mymulti :as mymulti]
  ...
  (:import [org.apache.commons.rng UniformRandomProvider]
           ...
           [elements.java.sets Intersects IntersectsAsm 
...
(defn integer-intervals
  ...
  (let [^DiscreteSampler sampler (uniform-integer-sampler z0 z1)]
    (fn integer-interval 
      ^elements.java.numbers.IntegerInterval []
      (let [z0 (.sample sampler)
            z1 (.sample sampler)]
        (if (<= z0 z1)
